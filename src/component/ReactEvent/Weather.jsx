        ...
        <div className="container-fluid">
            <div className="mt-5 d-flex justify-content-center">
                <div className="w-50">
                    ...
                    <div style={{ marginTop: '50px', border: '2px solid black', padding: '30px', boxShadow: '5px 5px 5px grey', textAlign: 'center',backgroundImage:`url(${(weather.weather[0].description==='clear sky')?'Clear-Sky.jpg':'overcast-cloud.jpg'})`,color:"yellow",backgroundSize:"cover" }}>
